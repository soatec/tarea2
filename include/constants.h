...
const system_call_information syscalls_info[SYSCALLS_QUANTITY] = {
        ...
        {"sys_read",{"unsigned int","char *","size_t","","", ""}},
        {"sys_write",{"unsigned int","const char *","size_t","","", ""}},
        {"sys_open",{"const char *","int","int","","", ""}},
        {"sys_close",{"unsigned int","","","","", ""}},
        {"sys_waitpid",{"pid_t","unsigned int *","int","","", ""}},
        {"sys_creat",{"const char *","int","","","", ""}},
        {"sys_link",{"const char *","const char *","","","", ""}},
        {"sys_unlink",{"const char *","","","","", ""}},
        {"sys_execve",{"struct pt_regs","","","","", ""}},
        {"sys_chdir",{"const char *","","","","", ""}},
        {"sys_time",{"int *","","","","", ""}},
        {"sys_mknod",{"const char *","int","dev_t","","", ""}},
        {"sys_chmod",{"const char *","mode_t","","","", ""}},
        {"sys_lchown",{"const char *","uid_t","gid_t","","", ""}},
        {"",{"","","","","",""}},
        {"sys_stat",{"char *","struct __old_kernel_stat *","","","", ""}},
        {"sys_lseek",{"unsigned int","off_t","unsigned int","","", ""}},
        {"sys_getpid",{"","","","","", ""}},
        {"sys_mount",{"char *","char *","char *","","", ""}},
        {"sys_oldumount",{"char *","","","","", ""}},
        {"sys_setuid",{"uid_t","","","","", ""}},
        {"sys_getuid",{"","","","","", ""}},
        {"sys_stime",{"int *","","","","", ""}},
        {"sys_ptrace",{"long","long","long","long","", ""}},
        {"sys_alarm",{"unsigned int","","","","", ""}},
        {"sys_fstat",{"unsigned int","struct __old_kernel_stat *","","","", ""}},
        {"sys_pause",{"","","","","", ""}},
        {"sys_utime",{"char *","struct utimbuf *","","","", ""}},
        {"",{"","","","","",""}},
        {"",{"","","","","",""}},
        {"sys_access",{"const char *","int","","","", ""}},
        {"sys_nice",{"int","","","","", ""}},
        {"",{"","","","","",""}},
        {"sys_sync",{"","","","","", ""}},
        {"sys_kill",{"int","int","","","", ""}},
        {"sys_rename",{"const char *","const char *","","","", ""}},
        {"sys_mkdir",{"const char *","int","","","", ""}},
        {"sys_rmdir",{"const char *","","","","", ""}},
        {"sys_dup",{"unsigned int","","","","", ""}},
        {"sys_pipe",{"unsigned long *","","","","", ""}},
        {"sys_times",{"struct tms *","","","","", ""}},
        {"",{"","","","","",""}},
        {"sys_brk",{"unsigned long","","","","", ""}},
        {"sys_setgid",{"gid_t","","","","", ""}},
        {"sys_getgid",{"","","","","", ""}},
        {"sys_signal",{"int","__sighandler_t","","","", ""}},
        {"sys_geteuid",{"","","","","", ""}},
        {"sys_getegid",{"","","","","", ""}},
        {"sys_acct",{"const char *","","","","", ""}},
        {"sys_umount",{"char *","int","","","", ""}},
        ...
        {"",{"","","","","",""}},
        {"sys_setpgid",{"pid_t","pid_t","","","", ""}},
        {"",{"","","","","",""}},
        {"sys_olduname",{"struct oldold_utsname *","","","","", ""}},
        {"sys_umask",{"int","","","","", ""}},
        {"sys_chroot",{"const char *","","","","", ""}},
        {"sys_ustat",{"dev_t","struct ustat *","","","", ""}},
        {"sys_dup2",{"unsigned int","unsigned int","","","", ""}},
        {"sys_getppid",{"","","","","", ""}},
        {"sys_getpgrp",{"","","","","", ""}},
        {"sys_setsid",{"","","","","", ""}},
        {"sys_sigaction",{"int","const struct old_sigaction *","struct old_sigaction *","","", ""}},
        {"sys_sgetmask",{"","","","","", ""}},
        {"sys_ssetmask",{"int","","","","", ""}},
        {"sys_setreuid",{"uid_t","uid_t","","","", ""}},
        {"sys_setregid",{"gid_t","gid_t","","","", ""}},
        {"sys_sigsuspend",{"int","int","old_sigset_t","","", ""}},
        {"sys_sigpending",{"old_sigset_t *","","","","", ""}},
        {"sys_sethostname",{"char *","int","","","", ""}},
        {"sys_setrlimit",{"unsigned int","struct rlimit *","","","", ""}},
        {"sys_getrlimit",{"unsigned int","struct rlimit *","","","", ""}},
        {"sys_getrusage",{"int","struct rusage *","","","", ""}},
        {"sys_gettimeofday",{"struct timeval *","struct timezone *","","","", ""}},
        {"sys_settimeofday",{"struct timeval *","struct timezone *","","","", ""}},
        {"sys_getgroups",{"int","gid_t *","","","", ""}},
        {"sys_setgroups",{"int","gid_t *","","","", ""}},
        {"old_select",{"struct sel_arg_struct *","","","","", ""}},
        {"sys_symlink",{"const char *","const char *","","","", ""}},
        {"sys_lstat",{"char *","struct __old_kernel_stat *","","","", ""}},
        {"sys_readlink",{"const char *","char *","int","","", ""}},
        {"sys_uselib",{"const char *","","","","", ""}},
        {"sys_swapon",{"const char *","int","","","", ""}},
        {"sys_reboot",{"int","int","int","void *","", ""}},
        {"old_readdir",{"unsigned int","void *","unsigned int","","", ""}},
        {"old_mmap",{"struct mmap_arg_struct *","","","","", ""}},
        {"sys_munmap",{"unsigned long","size_t","","","", ""}},
        {"sys_truncate",{"const char *","unsigned long","","","", ""}},
        {"sys_ftruncate",{"unsigned int","unsigned long","","","", ""}},
        {"sys_fchmod",{"unsigned int","mode_t","","","", ""}},
        {"sys_fchown",{"unsigned int","uid_t","gid_t","","", ""}},
        {"sys_getpriority",{"int","int","","","", ""}},
        {"sys_setpriority",{"int","int","int","","", ""}},
        {"",{"","","","","",""}},
        {"sys_statfs",{"const char *","struct statfs *","","","", ""}},
        {"sys_fstatfs",{"unsigned int","struct statfs *","","","", ""}},
        {"sys_ioperm",{"unsigned long","unsigned long","int","","", ""}},
        {"sys_socketcall",{"int","unsigned long *","","","", ""}},
        {"sys_syslog",{"int","char *","int","","", ""}},
        {"sys_setitimer",{"int","struct itimerval *","struct itimerval *","","", ""}},
        {"sys_getitimer",{"int","struct itimerval *","","","", ""}},
        {"sys_newstat",{"char *","struct stat *","","","", ""}},
        {"sys_newlstat",{"char *","struct stat *","","","", ""}},
        {"sys_newfstat",{"unsigned int","struct stat *","","","", ""}},
        {"sys_uname",{"struct old_utsname *","","","","", ""}},
        {"sys_iopl",{"unsigned long","","","","", ""}},
        {"sys_vhangup",{"","","","","", ""}},
        {"sys_idle",{"","","","","", ""}},
        {"sys_vm86old",{"unsigned long","struct vm86plus_struct *","","","", ""}},
        {"sys_wait4",{"pid_t","unsigned long *","int options","struct rusage *","", ""}},
        {"sys_swapoff",{"const char *","","","","", ""}},
        {"sys_sysinfo",{"struct sysinfo *","","","","", ""}},
        {"sys_ipc", {"uint","int","int","int","void *", ""}},
        {"sys_fsync",{"unsigned int","","","","", ""}},
        {"sys_sigreturn",{"unsigned long","","","","", ""}},
        {"sys_clone",{"struct pt_regs","","","","", ""}},
        {"sys_setdomainname",{"char *","int","","","", ""}},
        {"sys_newuname",{"struct new_utsname *","","","","", ""}},
        {"sys_modify_ldt",{"int","void *","unsigned long","","", ""}},
        {"sys_adjtimex",{"struct timex *","","","","", ""}},
        {"sys_mprotect",{"unsigned long","size_t","unsigned long","","", ""}},
        {"sys_sigprocmask",{"int","old_sigset_t *","old_sigset_t *","","", ""}},
        {"sys_create_module",{"const char *","size_t","","","", ""}},
        {"sys_init_module",{"const char *","struct module *","","","", ""}},
        {"sys_delete_module",{"const char *","","","","", ""}},
        {"sys_get_kernel_syms",{"struct kernel_sym *","","","","", ""}},
        {"sys_quotactl",{"int","const char *","int","caddr_t","", ""}},
        {"sys_getpgid",{"pid_t","","","","", ""}},
        {"sys_fchdir",{"unsigned int","","","","", ""}},
        {"sys_bdflush",{"int","long","","","", ""}},
        {"sys_sysfs",{"int","unsigned long","unsigned long","","", ""}},
        {"sys_personality",{"unsigned long","","","","", ""}},
        {"",{"","","","","",""}},
        {"sys_setfsuid",{"uid_t","","","","", ""}},
        {"sys_setfsgid",{"gid_t","","","","", ""}},
        {"sys_llseek",{"unsigned int","unsigned long","unsigned long","loff_t *","unsigned int", ""}},
        {"sys_getdents",{"unsigned int","void *","unsigned int","","", ""}},
        {"sys_select",{"int","fd_set *","fd_set *","fd_set *","struct timeval *", ""}},
        {"sys_flock",{"unsigned int","unsigned int","","","", ""}},
        {"sys_msync",{"unsigned long","size_t","int","","", ""}},
        {"sys_readv",{"unsigned long","const struct iovec *","unsigned long","","", ""}},
        {"sys_writev",{"unsigned long","const struct iovec *","unsigned long","","", ""}},
        {"sys_getsid",{"pid_t","","","","", ""}},
        {"sys_fdatasync",{"unsigned int","","","","", ""}},
        {"sys_sysctl",{"struct __sysctl_args *","","","","", ""}},
        {"sys_mlock",{"unsigned long","size_t","","","", ""}},
        {"sys_munlock",{"unsigned long","size_t","","","", ""}},
        {"sys_mlockall",{"int","","","","", ""}},
        {"sys_munlockall",{"","","","","", ""}},
        {"sys_sched_setparam",{"pid_t","struct sched_param *","","","", ""}},
        {"sys_sched_getparam",{"pid_t","struct sched_param *","","","", ""}},
        {"sys_sched_setscheduler",{"pid_t","int","struct sched_param *","","", ""}},
        {"sys_sched_getscheduler",{"pid_t","","","","", ""}},
        {"sys_sched_yield",{"","","","","", ""}},
        {"sys_sched_get_priority_max",{"int","","","","", ""}},
        {"sys_sched_get_priority_min",{"int","","","","", ""}},
        {"sys_sched_rr_get_interval",{"pid_t","struct timespec *","","","", ""}},
        {"sys_nanosleep",{"struct timespec *","struct timespec *","","","", ""}},
        {"sys_mremap",{"unsigned long","unsigned long","unsigned long","unsigned long","", ""}},
        {"sys_setresuid",{"uid_t","uid_t","uid_t","","", ""}},
        {"sys_getresuid",{"uid_t *","uid_t *","uid_t *","","", ""}},
        {"sys_vm86",{"struct vm86_struct *","","","","", ""}},
        {"sys_query_module",{"const char *","int","char *","size_t","size_t *", ""}},
        {"sys_poll",{"struct pollfd *","unsigned int","long","","", ""}},
        {"sys_nfsservctl",{"int","void *","void *","","", ""}},
        {"sys_setresgid",{"gid_t","gid_t","gid_t","","", ""}},
        {"sys_getresgid",{"gid_t *","gid_t *","gid_t *","","", ""}},
        {"sys_prctl",{"int","unsigned long","unsigned long","unsigned long","unsigned long", ""}},
        {"sys_rt_sigreturn",{"unsigned long","","","","", ""}},
        {"sys_rt_sigaction",{"int","const struct sigaction *","struct sigaction *","size_t","", ""}},
        {"sys_rt_sigprocmask",{"int","sigset_t *","sigset_t *","size_t","", ""}},
        {"sys_rt_sigpending",{"sigset_t *","size_t","","","", ""}},
        {"sys_rt_sigtimedwait",{"const sigset_t *","siginfo_t *","const struct timespec *","size_t","", ""}},
        {"sys_rt_sigqueueinfo",{"int","int","siginfo_t *","","", ""}},
        {"sys_rt_sigsuspend",{"sigset_t *","size_t","","","", ""}},
        {"sys_pread",{"unsigned int","char *","size_t","loff_t","", ""}},
        {"sys_pwrite",{"unsigned int","const char *","size_t","loff_t","", ""}},
        {"sys_chown",{"const char *","uid_t","gid_t","","", ""}},
        {"sys_getcwd",{"char *","unsigned long","","","", ""}},
        {"sys_capget",{"cap_user_header_t","cap_user_data_t","","","", ""}},
        {"sys_capset",{"cap_user_header_t","const cap_user_data_t","","","", ""}},
        {"sys_sigaltstack",{"const stack_t *","stack_t *","","","", ""}},
        {"sys_sendfile",{"int","int","off_t *","size_t","", ""}},
        {"",{"","","","","",""}},
        {"",{"","","","","",""}},
